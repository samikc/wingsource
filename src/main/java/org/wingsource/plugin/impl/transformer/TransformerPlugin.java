 ...
 */
package org.wingsource.plugin.impl.transformer;
...
public class TransformerPlugin implements Plugin {
	...
	public void service(PluginRequest request, PluginResponse response) {
		List<Object> operandList = (List<Object>) request.getAttribute(PluginRequest.OPERANDS);
		
		Object op1 = operandList.get(0);
		...
		response.setResponse(bos.toString());
	}
}
